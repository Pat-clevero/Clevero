async function handler(C) {
    ...
    console.log("Org Acitivity:")
    console.log({caseFieldValue})
    console.log(orgActivity);

    

    if (scoreType && showFieldsBasedOnScoreType[scoreType[0]]) {
        ...
        if (scoreType[0] === "2661277") { // Circumstances
            ...
            // Show fields if secondary domain is required
        ...
        } else if (scoreType[0] === "2661278") { // GOALS
            console.log("GOALS");

            if (orgActivity[0] === "2679629") {
                // NDAP
                console.log("NDAP");
                actions.push(
                    C.setFieldMandatory("2580357-empowerment", true), // set Empowerment to mandatoy
                    C.setFieldHidden("2580357-confidence", true),
                    C.setFieldHidden("2580357-confidence-definitions", true)
                );
                
            } else if (orgActivity[0] === "2679636") { // 2679636-NDIS 2693678-WA Dept.
                // NDIS
                console.log("NDIS");
                
                actions.push(
                    C.setFieldMandatory("2580357-empowerment", false), // set Empowerment to not mandatoy
                    C.setFieldHidden("2580357-confidence", true),
                    C.setFieldHidden("2580357-confidence-definitions", true),
                    C.setFieldHidden("2580357-skills", true),
                    C.setFieldHidden("2580357-skills-definitions", true),
                    C.setFieldHidden("2580357-behaviours", true),
                    C.setFieldHidden("2580357-behaviours-definitions", true)
                );
