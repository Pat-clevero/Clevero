async function handler(C) {
    ...
    const percentageDiscount = C.getSubValueBasedOnIndex(internalId, index)
        .discount;
    ...
    if (taxRate.length != 0) {
        ...
        taxRateAmount = taxRateObject["effective-tax-rate"]/100;
        //taxAmount = +netAmount * 0.1;
        taxAmount = +netAmount * taxRateAmount;
    }
