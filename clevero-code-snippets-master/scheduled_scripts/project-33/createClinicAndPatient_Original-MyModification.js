    ...
    if (clinicValue == 2055581) {
        ...
        const createClinicResponse = await C.createEntry({
            ...
            value: {
                ...
                "1918262-general-email": clinicEmail
            },
        });
        ...
        if (patientValue1 == 2055581) {
            const createPatientResponse = await C.createEntry({
                ...
                value: {
                    ...
                    "1918262-breed": currentEntry["1918262-breed-1"] ? currentEntry["1918262-breed-1"] : [],
                    "1918262-sex": currentEntry["1918262-sex-1"],
                    "1918262-clinic": clinicId,
                    "1918262-full-name": fullName,
                    "1918262-bodyweight": currentEntry["1918262-bodyweight-1"]
                },
            });
        ...
        if (patientValue2 == 2055581) {
            ...
            const createPatientResponse = await C.createEntry({
                ...
                value: {
                    ...
                    "1918262-breed": currentEntry["1918262-breed-2"] ? currentEntry["1918262-breed-2"] : [],
                    "1918262-sex": currentEntry["1918262-sex-2"],
                    "1918262-clinic": clinicId,
                    "1918262-full-name": fullName,
                    "1918262-bodyweight": currentEntry["1918262-bodyweight-2"]
                },
            });
        ...
        if (patientValue3 == 2055581) {
            ...
            const createPatientResponse = await C.createEntry({
                ...
                value: {
                    ...
                    "1918262-breed": currentEntry["1918262-breed-3"] ? currentEntry["1918262-breed-3"] : [],
                    "1918262-sex": currentEntry["1918262-sex-3"],
                    "1918262-clinic": clinicId,
                    "1918262-full-name": fullName,
                    "1918262-bodyweight": currentEntry["1918262-bodyweight-3"]
                },
            });
            ...
            updates: [
                {
                    ...
                    entryId: +id,
                    value: {
                        "1918262-name": appointmentName ? appointmentName : "",
                        "1918262-linked-online-booking": [currentEntry.recordValueId],
                    },
                },
            ],
        });
