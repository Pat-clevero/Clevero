async function script(C) {
    ...
    lineItems.map((val, index) => {
        ...
        const applyDiscount = currentLine["2708638-apply-discount"] || false;
        const netValue =
            currentLine["2708638-final-number-of-kids"] *
            currentLine["2708638-rate-per-head"];
        ...
        orderLineValues.push({
            "2708638-session": [currentLine.recordValueId],
            item: currentLine["2708638-xero-item"],
            description: currentLine["2708638-invoice-line-description"],
            quantity: currentLine["2708638-final-number-of-kids"],
            rate: currentLine["2708638-rate-per-head"],
            "tax-rate": [300101130],
            account:
                secondaryJobTypeOjbect[0]["2708638-default-revenue-account"],
        ...
        if (applyDiscount) {
            const discountNetValue =
                currentLine["2708638-final-number-of-kids"] * -6;
    ...
    let initialDiscount = currentEntry["2708638-initial-deposit-amount"];
    orderLineValues.push({
        item: [300101398],
